...
class DataCollector:
    ...
    def __init__(self, data_dir=None):
        ...
        Args:
            data_dir: Diretório onde os dados serão salvos (None = usa data_collected/ na raiz)
        """
        if data_dir is None:
            # Usa data_collected/ na raiz do projeto
            self.data_dir = Path(__file__).parent.parent.parent / "data_collected"
        else:
